...
We will need the a refinement of the restricted invertibility theorem of
Bourgain and Tzafriri~\cite{bour-tza} due to Spielman and Srivastava.
...
where $\lambda_{\rm min}(Q_{S,S})$ is the minimum eigen value of $Q_{S,S}$.
\end{theorem}
